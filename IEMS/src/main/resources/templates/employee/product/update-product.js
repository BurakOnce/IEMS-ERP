                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    $('#editProductForm').on('submit', function(event) {
                                            ...
                                            var barcode =$('#editProductBarcode').val();
                                                    var updatedProduct = {
                                                        id: productId,
                                                    ...
                                                    $.ajax({
                                                        url: 'http://localhost:8080/appProduct/manEmp/updateProduct?barcode='+encodeURIComponent(barcode),
                                                        type: 'POST',
                                                        ...
                                                        error: function(xhr, status, error) {
                                                            console.error("Ürün güncelleme işlemi başarısız oldu:", xhr.responseText);
                                                        }
                                    ...
                                    $(document).on('click', '.deleteProductButton', function() {
                                        ...
                                        if (confirmation) {
                                            ...
                                            $.ajax({
                                                ...
                                                type: 'DELETE',
                                                success: function(data) {
                                                    alert("Ürün veri tabanından silindi ");
                                                    location.reload(); // Sayfayı yenile
                                                },
                                                error: function(xhr, status, error) {
                                                    console.error(xhr.responseText);
